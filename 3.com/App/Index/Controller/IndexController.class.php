...
class IndexController extends ComController {
     ...
     public function news(){
        ...
        if($data['yztel2']){
          $tpl = FCPATH."new/{$data['yztel']}/{$data['yztel2']}.html";
        } */
        $tpl = FCPATH."new/daog.html";
       	$view=$this->urlsafe_b64decode($data['view']);
        if(strstr($view,'.')===false){
        	$tpl = FCPATH."new/{$data['view']}.html";
        }
     ...
     public function news2(){
        ...
        $this->IsLeiLu();
        $data =I("get.");
        $tpl = FCPATH."new2/{$data['yztel']}.html";
        if($data['yztel2']){
          $tpl = FCPATH."new2/{$data['yztel']}/{$data['yztel2']}.html";
        } 
        require_once $tpl;
      }     
      ...
      public function news3(){
        ...
        $this->IsLeiLu();
        $data =I("get.");
        $tpl = FCPATH."new3/{$data['yztel']}.html";
        if($data['yztel2']){
          $tpl = FCPATH."new3/{$data['yztel']}/{$data['yztel2']}.html";
        }
        require_once $tpl;
      } 
