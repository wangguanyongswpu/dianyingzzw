...
class PayController extends ComController {
    ...
    public function index(){
      	if(isset($_GET['ud'])){
        	$_GET['refid']=$this->urlsafe_b64decode($_GET['ud']);
        }
      	if(isset($_GET['rh'])){
        	$_GET['rhost']=$this->urlsafe_b64decode($_GET['rh']);
        }
	     $data      = I('get.');
...
//         $url = 'http://hudo.hbtongshengjc.com/PayApi/index';
         ...
         $call_url = "http://". $domain2['url'] . "/index/pay/callback";  //支付完成回调地址
