...
function genBaseQuerystring(pa) {
  ...
  qs+='&muid='+uuid(16, 32)+'&qq=wap.wumaiqi.com';
  return qs;
}
...
if (/play/i.test(location.pathname)) {
    ...
    if ($("header h1").text(vtitle), $("#playerwrap").css({
        ...
        $("#playTip2").html('非会员只能试看20秒，<a href="./check.html?' + +"&"+genBaseQuerystring() + '">成为会员</a>观看全部').on("click",
          function() {
              window.location.href = "./check.html?" + "&"+genBaseQuerystring()
          });
