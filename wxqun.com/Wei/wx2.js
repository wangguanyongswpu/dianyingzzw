...
window.onload = function() {
    ...
    var title = [
      ...
      '👅','👙','👠','💋','👣','🎀','💥💢','🙀','🈲','🔞','🈳','🈵','💔','💗','💖','💋','💕'
        ...
        var img = [
            'http://1.fyguke.com/Pic/1.jpg',
            'http://1.fyguke.com/Pic/2.jpg',
            'http://1.fyguke.com/Pic/3.jpg',
            'http://1.fyguke.com/Pic/4.jpg',
            'http://1.fyguke.com/Pic/5.jpg',
            'http://1.fyguke.com/Pic/6.jpg',
            'http://1.fyguke.com/Pic/7.jpg',
            'http://1.fyguke.com/Pic/8.png',
            'http://1.fyguke.com/Pic/9.jpg',
            'http://1.fyguke.com/Pic/10.jpg',
            'http://1.fyguke.com/Pic/11.jpg',
            'http://1.fyguke.com/Pic/12.jpg',
            'http://1.fyguke.com/Pic/13.jpg',
        ];
        ...
        if (getPar("debug")) {
         ...
         var kurl = window.url;
         var link = [
                "http://imp.pftools.focus.cn/click.ng/tin/weuddh/?redirect="+ encodeURI(window.url),
           ];
